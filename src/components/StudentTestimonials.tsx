  ...
  const testimonials: Testimonial[] = [
    {
      ...
      quoteEn: "Learning traditional Bengali heritage recipes under Chef Afroza completely transformed my approach. The timing of 'Phoron' tempering was a game-changer! Highly recommended academy.",
      quoteBn: "শেফ আফরোজার অধীনে ঐতিহ্যবাহী বাঙালি রান্নার কোর্সটি আমার রান্নার পদ্ধতি বদলে দিয়েছে। সঠিক সময়ে ফোড়ন দেওয়ার কৌশলটি সত্যি অসাধারণ! এই একাডেমিটির প্রতিটি মডিউল দারুণ গোছানো।",
      rating: 5,
