...
const LEVEL_METADATA: Record<number, {
  ...
  4: {
    qualificationEn: "Professional Diploma in Culinary Arts",
    qualificationBn: "প্রফেশনাল ডিপ্লোমা ইন কালিনারি আর্টস",
    durationEn: "15 Days",
    durationBn: "১৫ দিন",
    hoursEn: "120 Training Hours",
    hoursBn: "১২০ প্রশিক্ষণ ঘন্টা",
    feeEn: "USD 1,200",
    feeBn: "১,২০০ মার্কিন ডলার (৳১,৪৪,০০০)",
    stageEn: "Senior Commis / Kitchen In-Charge",
    stageBn: "সিনিয়র কমিস / কিচেন ইন-চার্জ",
  },
  5: {
    qualificationEn: "Professional Diploma in Specialised Cuisine",
    qualificationBn: "প্রফেশনাল ডিপ্লোমা ইন স্পেশালাইজড কুইজিন",
    durationEn: "15 Days",
    durationBn: "১৫ দিন",
    hoursEn: "120 Training Hours",
    hoursBn: "১২০ প্রশিক্ষণ ঘন্টা",
    feeEn: "USD 1,400",
    feeBn: "১,৪০০ মার্কিন ডলার (৳১,৬৮,০০০)",
    stageEn: "Chef de Partie",
    stageBn: "শেফ ডি পার্টি",
  },
  6: {
    qualificationEn: "Advanced Professional Diploma in Specialized Cuisine",
    qualificationBn: "অ্যাডভান্সড প্রফেশনাল ডিপ্লোমা ইন স্পেশালাইজড কুইজিন",
    durationEn: "15 Days",
    durationBn: "১৫ দিন",
    hoursEn: "120 Training Hours",
    hoursBn: "১২০ প্রশিক্ষণ ঘন্টা",
    feeEn: "USD 1,600",
    feeBn: "১,৬০০ মার্কিন ডলার (৳১,৯২,০০০)",
    stageEn: "Sous Chef",
    stageBn: "সু শেফ",
  }
};
                        ...
                        <div className="border border-editorial-border p-4 space-y-3 bg-white">
                          ...
                          <div className="space-y-1.5 text-xs">
                            {[
                              ...
                              { en: "Viva Board", bn: "ভাইভা বোর্ড (মৌখিক পরীক্ষা)" }
                            ].map((req, idx) => (
