...
export const INITIAL_COURSES: Course[] = [
  ...
  {
    id: "course-4",
    titleEn: "Culinary Production & Operations Management",
    titleBn: "কালিনারি প্রোডাকশন এবং অপারেশনস ম্যানেজমেন্ট",
    descriptionEn: "Master the art of production coordination, kitchen layouts, and bulk catering.",
    descriptionBn: "কিচেন লেআউট, বাল্ক ক্যাটারিং এবং প্রোডাকশন সমন্বয়ের শিল্পে পারদর্শী হয়ে উঠুন।",
    price: 1800,
